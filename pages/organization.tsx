    ...
    <div>
      ...
      <Form {...form}>
        ...
        >
          ...
          />
          <div style={boxStyle}>
            {dataUrl ? ( // This is the base64 image -- i.e. data:image/png;base64,....
          ...
          {dataUrl && (
            <div>
              <p>Mime: {dataUrl.split(":")[1].split(";")[0]}</p>
              <p>Buffer: {dataUrl.split(",")[1]}</p>
            </div>
          )}
...
//             setImage(dataUrl); // Set the base64 data URL
//           }
//         };
